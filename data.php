                    ...
                    do { ?>
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="addEditData.php?delete=<?php echo $row_query['kode_barang'] ?>" onclick="return confirm('Yakin ingin menghapus data ?')" class="btn btn-danger" title="Hapus Data"><i class="fa fa-trash"></i></a>
                            </td>
                        </tr>
